...
public class Wrappers {
    ...
    public void selectSkill(WebDriver driver, String skill) {
        List<WebElement> choices = driver
                .findElements(By.xpath("//div[@jscontroller='sW52Ae']//div[@role='listitem']//div[@role='checkbox']"));
    ...
    public void selectAddressedBy(WebDriver driver, String title) {
        List<WebElement> choices = driver
                .findElements(By.xpath("//div[@class='OA0qNb ncFHed QXL7Te']//div[@jsname='wQNmvb']"));
